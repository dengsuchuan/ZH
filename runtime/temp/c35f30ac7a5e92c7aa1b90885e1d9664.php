<?php /*a:1:{s:73:"/home/dengsuchuan/Documents/Web/ZH/application/admin/view/user/login.html";i:1527493200;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="container">
    <div class="row">
        <div class="col-md-6 col-md-offset-3 thumbnail">
            ...
            <form method="post" id="login" class="form-signin" role="form" action="<?php echo url('admin/user/checkLogin'); ?>">
                <fieldset>
