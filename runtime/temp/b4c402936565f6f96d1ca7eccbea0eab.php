<?php /*a:6:{s:75:"/home/dengsuchuan/Documents/Web/ZH/application/index/view/index/insert.html";i:1536568438;s:74:"/home/dengsuchuan/Documents/Web/ZH/application/index/view/public/base.html";i:1525254418;s:77:"/home/dengsuchuan/Documents/Web/ZH/application/index/view/public//header.html";i:1526806562;s:74:"/home/dengsuchuan/Documents/Web/ZH/application/index/view/public//nav.html";i:1536568508;s:76:"/home/dengsuchuan/Documents/Web/ZH/application/index/view/public//right.html";i:1536567979;s:77:"/home/dengsuchuan/Documents/Web/ZH/application/index/view/public//footer.html";i:1536559456;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
...
<div class="row">
    <div class="col-md-8">
        ...
        <form method="post" id="login" action="<?php echo url('index/index/save'); ?>" enctype="multipart/form-data">
            <input type="hidden" name="user_id" value="<?php echo htmlentities(app('session')->get('user_id')); ?>">
            <fieldset>
                <div class="form-group">
                    <label for="title">标题:</label>
                    <input type="text" class="form-control" id="title" name="title" placeholder="articleTitle">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" id="content" name="content" placeholder="ArticleContent" style="min-height: 300px;"></textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="title_img" name="title_img" class="form-control">
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item" title="<?php echo htmlentities($pvList['title']); ?>">
            <marquee direction="left" behavior="alternate" scrollamount="1" scrolldelay="100">
                <a href="<?php echo url('index/index/index',['keyword'=>$pvList['title']]); ?>"><?php echo htmlentities($pvList['title']); ?> 【阅读量: <?php echo htmlentities($pvList['pv']); ?>】</a>
            </marquee>
