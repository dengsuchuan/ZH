<?php /*a:4:{s:69:"D:\WebServer\www\project\ZH\application/admin/view\cate\cateedit.html";i:1526373931;s:69:"D:\WebServer\www\project\ZH\application/admin/view\public\layout.html";i:1526269691;s:66:"D:\WebServer\www\project\ZH\application/admin/view\public\nav.html";i:1526366042;s:67:"D:\WebServer\www\project\ZH\application/admin/view\public\left.html";i:1526371260;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
...
<form class="form-horizontal" action="<?php echo url('user/doEdit'); ?>" method="post" onSubmit="return inputSu();">
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="name" name="name" placeholder="UserName" value="<?php echo htmlentities($userInfo['name']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="email" class="col-sm-2 control-label">邮箱</label>
        <div class="col-sm-10">
            <input type="email" class="form-control" id="email" name="email" placeholder="Email"  value="<?php echo htmlentities($userInfo['email']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="mobile" class="col-sm-2 control-label">手机</label>
        <div class="col-sm-10">
            <input type="number" class="form-control" id="mobile" name="mobile" placeholder="Mobile"  value="<?php echo htmlentities($userInfo['mobile']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="password" class="col-sm-2 control-label">密码</label>
        <div class="col-sm-10">
            <input type="password" class="form-control" id="password" name="password" placeholder="Password" value="<?php echo htmlentities($userInfo['password']); ?>">
        </div>
    </div>
...
<script>
    $(function inputSu() {
        ...
        $('#submit').on('click',function () {
            ...
            if(nameInput == name && emailInput == email && passwordInput == password && mobileInput == mobile){
