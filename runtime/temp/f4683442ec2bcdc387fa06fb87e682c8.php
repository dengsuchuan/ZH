    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class=" thumbnail">
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body" id="modal-body">
                                    ...
                                    <?php else: ?>
                                    <span>还没有登录哦，请先登录<a href="<?php echo url('user/login'); ?>">【点击登录】</a></span>
                                    <?php endif; ?>
                ...
                <ol class="breadcrumb text-center" style="width:550px;">
